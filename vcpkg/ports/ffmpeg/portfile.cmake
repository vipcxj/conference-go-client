...
if("v4l-utils" IN_LIST FEATURES)
    message(NOTICE "The feature v4l-utils need libv4l-dev package manually installed in the host machine.")
    set(OPTIONS "${OPTIONS} --enable-libv4l2")
endif()
